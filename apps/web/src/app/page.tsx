import {Scaffold, ScaffoldBody, ScaffoldFooter, ScaffoldHeader} from "layouts-rc";
  ...
  return (
      <main className="flex flex-col items-center  min-h-screen p-24">
        ...
        <Scaffold className="h-[600px] w-[400px] text-2xl font-semibold">
          ...
          <ScaffoldBody>
            <div
                className="relative h-[1200px] bg-gradient-to-b from-indigo-500 via-purple-500 to-pink-500">
              <h3 className="sticky top-0 px-4 py-2 border-4 border-transparent">Body</h3>
